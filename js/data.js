    ...
    events: [
      {
        ...
        steps: [
          ...
          { eatGame: { shape: 'icecream', illustration: 'icecream.webp', word: 'Ice Cream', bites: 3 } },
        ...
        steps: [
          ...
          { look: {
            ...
            fallback: {
              ...
              attract: { id: 'roo', anim: 'hop', sfx: 'boing', every: 1800 },
            },
          } },
          { cam: { x: 630, y: 400, s: 1.16, dur: 900 } },
          { move: { id: 'au_ranger', x: 480, dur: 600 } },
          ...
          { say: ['au_ranger', 'It jumps very high!', 'とても高くジャンプするんだよ！'], jpMode: 'visible' },
          { sfx: 'boing' }, { anim: { id: 'roo', name: 'hop' } },
          { fx: ['sparkles', 660, 430] },
          { photo: true },
        ],
    ...
    events: [
      {
        ...
        steps: [
          ...
          { say: ['fr_vendor', 'It means "hello"!', 'フランス語で「こんにちは」！'], jpMode: 'visible' },
          ...
          { eatGame: { shape: 'crepe', illustration: 'crepe.webp', word: 'Crepe', bites: 3 } },
          { reaction: { kind: 'food-feast', duration: 1000 } },
          { mood: ['player', 'wow'] },
          { auto: ['player', 'Yummy!', 'おいしい！'] },
          { photo: true },
      ...
      },
      {
        ...
        steps: [
          ...
          { look: {
            targetRect: { x: 400, y: 0, w: 160, h: 0 },
            mode: 'tower', axis: 'y', startPct: 100, radius: 48, hold: 600,
            prompt: 'Look up!', promptJP: '上を見て！', found: 'Found it!',
          } },
          { wait: 300 },
          { sfx: 'chime' },
          ...
          { say: ['fr_guide', 'It sparkles at night!', '夜はキラキラ光るのよ！'], jpMode: 'visible' },
    ...
    events: [
      {
        ...
        steps: [
          ...
          { eatGame: { shape: 'kebab', illustration: 'kebab.webp', word: 'Kebab', bites: 3 } },
          { reaction: { kind: 'food-feast', duration: 1000 } },
          { mood: ['player', 'wow'] },
          { auto: ['player', 'Yummy!', 'おいしい！'] },
          { photo: true },
      ...
      },
      {
        ...
        steps: [
          ...
          { say: ['eg_guide', 'It is 4,500 years old!', '4500年前のものだよ！'], jpMode: 'visible' },
          { say: ['eg_guide', 'Now find my camel, Coco!', 'ラクダのココをさがして！'] },
          { look: {
            presentation: 'observe', panorama: 'look_egypt_desert.webp',
            size: { w: 3000, h: 1000 }, window: { w: 1280, h: 800 },
            target: 'observe_coco', axis: 'xy', start: 'previous', radius: 180, hold: 600,
            prompt: 'Find Coco!', promptJP: 'ココをさがして！', found: 'Found it!',
            sprites: [{
              id: 'observe_coco', char: 'camel', x: 1350, footY: 880, height: 300,
              anim: 'wiggle', attract: { sfx: 'camel', every: 2200 },
            }],
            decoys: [{
