    ...
    events: [
      {
        ...
        steps: [
          ...
          { move: { id: 'ice', x: 300, y: 432, dur: 800 } },
          { cam: { x: 300, y: 430, s: 1.26, dur: 2200 } },
          { fx: ['sparkles', 300, 415] },
          { sfx: 'bite' },
          { mood: ['player', 'wow'] },
    ...
    events: [
      {
        ...
        steps: [
          ...
          { auto: ['player', 'Thank you!', 'ありがとう！'] },
          { move: { id: 'crepe', x: 285, y: 432, dur: 800 } },
          { cam: { x: 285, y: 430, s: 1.26, dur: 2200 } },
          { fx: ['sparkles', 285, 415] },
          { sfx: 'bite' },
          { mood: ['player', 'wow'] },
          { auto: ['player', 'Yummy!', 'おいしい！'] },
    ...
    events: [
      {
        ...
        steps: [
          ...
          { auto: ['player', 'Thank you!', 'ありがとう！'] },
          { move: { id: 'keb', x: 300, y: 432, dur: 800 } },
          { cam: { x: 300, y: 430, s: 1.26, dur: 2200 } },
          { fx: ['sparkles', 300, 415] },
          { sfx: 'bite' },
          { mood: ['player', 'wow'] },
